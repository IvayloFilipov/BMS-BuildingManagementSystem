namespace BuildingManagementSystem.Services.Data.Registrations.RegisterAddress
{
    ...
    {
        Task<int> AddAddressAsync(int cityId, string district, string street, string streetNumber, string blockNumber, string entranceNumber, string floor, string appartNumber);
