namespace BuildingManagementSystem.Web.Areas.Identity.Pages.Account.Manage
{
    ...
    public partial class EmailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (this.Input.NewEmail != email)
            {
                ...
                this.StatusMessage = "Линк за потвърждение за промяна на изпратения имейл. Моля, проверете електронната си поща.";
        ...
        public async Task<IActionResult> OnPostSendVerificationEmailAsync()
        {
            ...
            this.StatusMessage = "Изпратен е имейл за потвърждение. Моля, проверете електронната си поща.";
            return this.RedirectToPage();
        }
